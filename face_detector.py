...
def haar_Detection(image):
    ...
    if len(faces):
        ...
        for (x, y, w, h) in faces:
            ...
            cv2.rectangle(copy_img, (x, y), (x + w, y + h), (225, 242, 0), 2)
            i +=1

        cv2.imwrite(os.path.join(path, detect_dir, name + "_detect.face.jpg"), copy_img)
        return copy_img
...
if __name__ == "__main__":
    path = "C:\\Users\\Student\PycharmProjects\pythonProject2\images1"
